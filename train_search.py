...
def main():
    ...
    valid_low_data_names = 'LOD_train/*'
...
def train(train_queue, valid_queue, model, enhance_architect, denoise_architect, optimizer_enhance, optimizer_denoise,
    ...
    for step, (input) in enumerate(train_queue):
        ...
        nn.utils.clip_grad_norm_(model.enhance_net_parameters(), args.grad_clip)
        ...
        if step % 10 == 0:
            ...
            nn.utils.clip_grad_norm_(model.denoise_net_parameters(), args.grad_clip)
